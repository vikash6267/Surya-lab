...
// import { updateCompletedLectures } from "../../slices/viewTESTSlice"
...
export const createProduct = async (data, token) => {
  ...
  export const editProduct = async (data, token) => {
    ...
    try {
      ...
      console.log("EDIT TEST API RESPONSE............", response)
      if (!response?.data?.success) {
        throw new Error("Could Not Update TEST Details")
      }
      toast.success("TEST Details Updated Successfully")
    
    } catch (error) {
      console.log("EDIT TEST API ERROR............", error)
      toast.error(error.message)
    }
    toast.dismiss(toastId)
     }
...
export const fetchCategory = async() =>{
  ...
  try {
    ...
    // console.log("TEST_CATEGORIES_API API RESPONSE............", response)
    if (!response?.data?.success) {
      throw new Error("Could Not Fetch TEST Categories")
    }
    result = response?.data?.data
  } catch (error) {
    console.log("TEST_CATEGORY_API API ERROR............", error)
    toast.error(error.message)
  }
  return result
}
